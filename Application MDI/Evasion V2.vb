Public Class Evasion_V2
    Private Sub Evasion_V2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub WB_NAVIGATEUR_Navigation(ByVal sender As System.Object, ByVal e As System.Windows.Forms.WebBrowserNavigatingEventArgs) Handles WB_NAVIGATEUR.Navigating
    ...
    Private Sub QuitterToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles QuitterToolStripMenuItem.Click
        If MsgBox("Voulez-vous vraiment quitter Evasion V2 ?", 36, "Quitter") = MsgBoxResult.Yes Then
            Close()
        End If
    End Sub

    Private Sub nwe_ongle_Click(sender As Object, e As EventArgs) Handles nouv_onglet.Click
        'New Evasion_V2
    End Sub
