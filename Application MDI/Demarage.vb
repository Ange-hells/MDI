Public NotInheritable Class Demarage
    ...
    Private Sub Demarage_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If My.Application.Info.Title <> "" Then
            TitredeLApplication.Text = My.Application.Info.Title
        Else
            'Si le titre de l'application est absent, utilisez le nom de l'application, sans l'extension
            TitredeLApplication.Text = System.IO.Path.GetFileNameWithoutExtension(My.Application.Info.AssemblyName)
        End If
